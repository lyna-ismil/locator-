        ...
        <div className="container mx-auto px-4 py-6 lg:py-10 space-y-8">
          <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4 lg:gap-0">
            <div className="flex items-center gap-4">
              <div className="h-12 w-12 rounded-2xl bg-gradient-to-br from-lime-500 via-emerald-500 to-emerald-600 grid place-items-center shadow-lg">
                <Zap className="h-7 w-7 text-white" />
              </div>
              <div>
                <h1 className="text-2xl lg:text-3xl font-bold tracking-tight text-gray-900">Station Dashboard</h1>
                <p className="text-sm uppercase tracking-[0.2em] text-gray-500 font-medium">Owner Portal</p>
              </div>
            </div>
            <div className="flex items-center gap-3">
              ...
              <Button onClick={handleLogout} className="bg-red-600 hover:bg-red-700 text-white shadow-lg">
                Log Out
              </Button>
            </div>
          </div>
          ...
          <TiltCard className="bg-white/95 backdrop-blur-sm border border-gray-100 shadow-2xl">
            <Card className="border-none shadow-none">
              <CardContent className="p-0">
                <Tabs defaultValue="stations" className="w-full">
                  <div className="border-b border-gray-100 px-6 py-4">
                    <TabsList className="grid w-full grid-cols-3 lg:grid-cols-7 bg-gray-50/80 backdrop-blur-sm p-1 rounded-xl">
                      <TabsTrigger value="stations" className="flex items-center gap-2 text-xs lg:text-sm px-2 lg:px-4">
                      ...
                      <TabsTrigger value="reviews" className="flex items-center gap-2 text-xs lg:text-sm px-2 lg:px-4">
                  ...
                  <div className="p-6">
                    <TabsContent value="stations" className="space-y-6 mt-0">
                      ...
                      <StationList
                        stations={stations}
                        onEdit={handleEdit}
                        onDataChange={fetchStations}
                      />
                    </TabsContent>

                    <TabsContent value="active-sessions" className="space-y-6 mt-0">
                      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                        <div>
                    ...
                    <TabsContent value="reclamations" className="space-y-6 mt-0">
                      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                        <div>
